...
## 5. Опционально: print-agent (печать бланков на принтер)

Нужен, только если хотите реально печатать бланки (Epson EcoTank L3250 или
любой другой принтер, доступный драйверу ОС). Без него кнопка «Печать» создаёт
задание в очереди, которое никто не забирает (или можно скачать PDF вручную).
